<template>
    ...
    <q-list bordered separator>
      <q-item @click="navi('/doctor/home')" clickable v-ripple>
        <q-item-section>Dashboard</q-item-section>
      </q-item>

      <q-item @click="navi('/doctor/profile')" clickable v-ripple>
        <q-item-section>
          <q-item-label>Profile</q-item-label>
        </q-item-section>
      </q-item>
      <q-item @click="navi('/doctor/patients')" clickable v-ripple>
        <q-item-section>
          <q-item-label overline>Patients</q-item-label>
        </q-item-section>
      </q-item>
      <q-item @click="goUrl('/doctor/login')" clickable v-ripple>
        <q-item-section>
